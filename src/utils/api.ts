...
export const getConversationById = (id: number) => axiosClient.get<Conversation>(`/conversations/${id}`, config)
...
export const deleteMessage = ({ id, messageId }: DeleteMessageParams) => axiosClient.delete<DeleteMessageResponse>(`/conversations/${id}/messages/${messageId}`, config)

export const editMessage = ({ content, id, messageId }: EditMessagePayload) => axiosClient.patch<MessageType>(`/conversations/${id}/messages/${messageId}`, { content }, config)
...
export const fetchGroupMessages = (id: number) => axiosClient.get<FetchGroupMessagePayload>(`/groups/${id}/messages`, config)
...
export const fetchFriendRequests = () => axiosClient.get<FriendRequest[]>("/friends/requests", config)
...
export const removeFriend = (id: number) => axiosClient.delete<Friend>(`/friends/${id}/delete`, config)
