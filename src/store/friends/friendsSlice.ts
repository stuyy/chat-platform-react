...
export const { addFriendRequest, removeFriendRequest, setOnlineFriends, setOfflineFriends, toggleContextMenu, setContextMenuLocation, setSelectedFriend, removeFriend } = friendsSlice.actions
