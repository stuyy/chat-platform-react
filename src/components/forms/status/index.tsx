...
import { InputContainer, InputContainerHeader, InputField, InputLabel } from "../../../utils/styles"
  ...
  return (
    <form className={styles.updateUserStatusForm} onSubmit={saveStatus}>
      <InputContainer backgroundColor="#0A0A0A">
        ...
        <InputField type="test" id="message" value={statusMessage} onChange={(e) => setStatusMessage(e.target.value)} />
      </InputContainer>
