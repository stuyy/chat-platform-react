...
import { InputContainer, InputLabel, TextField, Button, RecipientChipContainer, InputField } from "../../utils/styles"
...
export const CreateGroupForm: FC<Props> = ({ setShowModal }) => {
  ...
  return (
    <form className={styles.createConversationForm} onSubmit={onSubmit}>
      ...
      {results.length > 0 && query && <RecipientResultContainer userResults={results} handleUserSelect={handleUserSelect} />}
