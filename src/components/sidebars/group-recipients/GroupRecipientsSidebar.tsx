import { GroupRecipientSidebarItem, GroupRecipientSidebarItemContainer, GroupRecipientsSidebarHeader, GroupRecipientsSidebarStyle } from "../../../utils/styles"
  ...
  return (
    <GroupRecipientsSidebarStyle>
      ...
      <GroupRecipientSidebarItemContainer>
        ...
        <OnlineGroupRecipients users={onlineUsers} group={group} onUserContextMenu={onUserContextMenu} />
        <span>Offline Users</span>
        <OfflineGroupRecipients onlineUsers={onlineUsers} group={group} onUserContextMenu={onUserContextMenu} />
        {groupSidebarState.showUserContextMenu && <SelectedParticipantContextMenu points={groupSidebarState.points} />}
      </GroupRecipientSidebarItemContainer>
    </GroupRecipientsSidebarStyle>
  )
}
