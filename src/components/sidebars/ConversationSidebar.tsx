...
import { ConversationSearchbar, ConversationSidebarHeader, ConversationSidebarStyle, ConversationsScrollableContainer } from "../../utils/styles"
...
export const ConversationSidebar = () => {
  ...
  return (
    <>
      {showModal && conversationType === "private" && <CreateConversationModal setShowModal={setShowModal} />}
      {showModal && conversationType === "group" && <CreateGroupModal setShowModal={setShowModal} />}
      <ConversationSidebarStyle>
        ...
        <ConversationsScrollableContainer>
          <SidebarContainerStyle>
            {conversationType === "private"
              ? conversations.map((conversation) => <ConversationSidebarItem key={conversation.id} conversation={conversation} />)
              : groups.map((group) => <GroupSidebarItem key={group.id} group={group} onContextMenu={onGroupContextMenu} />)}
