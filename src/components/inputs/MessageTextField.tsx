...
export const MessageTextField: FC<Props> = ({ message, setMessage, maxLength, setIsMultiLine, sendTypingStatus, sendMessage }) => {
  ...
  return (
    <MessageTextarea ref={ref} value={message} onChange={onMessageChange} placeholder="Send a Message" maxLength={maxLength} onKeyDown={onKeyDown} onDrop={onDrop} onPaste={onPaste}></MessageTextarea>
  )
}
